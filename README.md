...
- [Testing Web APIs](https://www.manning.com/books/testing-web-apis): A book that teaches you the many ways in which APIs can be tested and how to put them into a testing strategy.
